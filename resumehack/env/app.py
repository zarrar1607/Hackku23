...
def out():
    ...
    cl_document.add_paragraph(cover_text)
    r_document.add_paragraph(resume_text)

    cl_document.save('coverletter.docx')
    r_document.save('resume.docx')

    # send_file("resume.docx", mimetype=None, as_attachment=True, download_name="download")
    return send_file("coverletter.docx", mimetype=None, as_attachment=True, download_name="cover")
